/**
 * Create a new therapist account in Firebase
 * Usage: node create_therapist.js
 */
...
// Therapist details - MODIFY THESE
const THERAPIST_EMAIL = 'therapist2@speaksteps.com';
const THERAPIST_PASSWORD = 'therapist123';  // User should change this after first login
const THERAPIST_NAME = 'Dr. Sarah Johnson';
...
async function createTherapist() {
  try {
    ...
    // Step 3: Summary
    console.log('✨ SUCCESS! Therapist account created:\n');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    ...
    console.log('🌐 Login at: https://speaksteps-hackathon.web.app\n');
